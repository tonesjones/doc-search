...
2. Connect to your SCM:
   ...
   2. Select Azure Repos.
   3. Enter the token created in Azure DevOps (see Prerequisites) under Repository Access Token.

      Note: The access token provided here will be used to complete the onboarding process and will be subject to rate limits enforced by Azure.
   4. Click Connect.
...
4. Repository Mapping: This will be different according to which method is selected.
   ...
   1. Automatic Mapping: Lists the organization/projects as applications and repositories as projects. You can view repositories to be imported by using the pulldowns (read only).
   ...
   In Polaris, names of applications will be Azure Project name (Azure Organization name).
