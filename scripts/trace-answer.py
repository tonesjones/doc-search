...
from evaluation.core import dump_json, make_trace, run_adapter  # noqa: E402
...
def main() -> int:
    ...
    trace = make_trace(case, run_adapter(command, case, args.timeout), profile_metadata(profile))
