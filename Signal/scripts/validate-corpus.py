#!/usr/bin/env python3
"""Validate Signal topic files, metadata, and stored content hashes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Signal corpus files and manifest metadata")
