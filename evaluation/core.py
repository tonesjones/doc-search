...
def make_trace(case: dict[str, Any], result: dict[str, Any], provenance: dict[str, Any]) -> dict[str, Any]:
...
def validate_trace(trace: dict[str, Any], expected_provenance: dict[str, Any] | None = None) -> list[str]:
    ...
    for field in (
        ...
        "evaluation_profile", "entrypoint", "checkout_revision",
        "instruction_revision", "source_revision", "prompt_revision",
    ):
