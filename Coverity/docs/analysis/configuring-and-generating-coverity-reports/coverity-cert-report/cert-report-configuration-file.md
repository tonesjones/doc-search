---
title: "CERT report configuration file"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cert-report-configuration-file.html"
content_id: "Rmaosp570r5_LGTtOZ~XGQ"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:38:10.395143+00:00"
---

# CERT report configuration file
...
The following table describes the CERT Report specific settings.

| Key | Description |
| --- | --- |
| `cert-report` | Declares the CERT Report settings. |
| `target-level` | [Optional] This setting is used to determine the CERT configuration for target levels. The default value is `F`. The following values are valid:  - `F`: Fully Compliant - `L2`: L2 Compliant - `L1`: L1 Compliant |
