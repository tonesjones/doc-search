---
title: "Black Duck Software Integrity Report configuration file"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/black-duck-software-integrity-report-configuration-file.html"
content_id: "8MYb~cDdPVWuayy7dnUjWA"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:39:24.233758+00:00"
---

# Black Duck Software Integrity Report configuration file
...
The following table describes the Black Duck Software Integrity Report specific settings.

| Key | Description |
| --- | --- |
| `bdsir-report` | Declares the Black Duck Software Integrity Report configuration settings. |
| `analysis-date` | [Optional] Lists date of report generation. The date should be written in MM/DD/YYYY format. This value can be specified in the configuration file or using the bd-generate-integrity-report command. If it is not specified using either method, the current date is used. |
| `include-false-positive` | [Optional]Specifies wether to include defects marked as "intentional" or "false positive" in the report. Possible values are `YES` and `NO`. The default value is `YES`. |
| `legal-text` | [Optional] This setting displays legal text in the report. For example, it will display something like this: "This is the first line of multiline legal text and this is the second line." |
| `show-checker-details` | [Optional] Specifies wether to display checker details information in the report. Possible values: `YES`, `NO`. The default value is `NO`. |
...
Once you have entered your settings, click File > Save As to save the configuration information for later use. The setting values
(except passwords) are saved in a configuration file.
