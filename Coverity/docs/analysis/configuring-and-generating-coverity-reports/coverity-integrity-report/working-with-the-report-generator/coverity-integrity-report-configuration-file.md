---
title: "Coverity Integrity Report configuration file"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/coverity-integrity-report-configuration-file.html"
content_id: "ZKBDnyTgFb8fg7rAHjsRKg"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:38:37.270490+00:00"
---

# Coverity Integrity Report configuration file
...
The following table describes the Coverity Integrity Report specific settings.

| Key | Description |
| --- | --- |
| `cir-report` | Declares the configuration settings for the Coverity Integrity Report. |
| `high-severity-name` | [Optional] Name of the highest severity value. The default value is `Major`. |
| `include-low-impact` | [Optional] Whether to include Low impact for calculating the defect density; this would be in addition to the High and Medium impact items shown in the report. Specify true to include Low impact, or false to exclude. Default value: false. |
| `loc-multiplier` | [Optional] LOC multiplier for the number of lines of code that have been inspected. Default value: 1 |
| `project-description` | [Optional] A short description of the project. The project description defaults to its description in Coverity Connect, if there is one available. |
| `project-details` | [Optional] This field lists the details of the project. |
| `target-integrity-level` | [Optional] Sets the target integrity level. The following target integrity levels are available:  - 1: < 1 defect per thousand lines of code - 2: < .1 defects per thousand lines of code - 3: < .01 defects per thousand lines of code, and other   requirements  Default value: 1 |
| `trial` | [Optional] This setting enables the trial flag. Uses the value `true` if page three of the report is not to be generated. (Page 3 contains severity data which is not relevant for projects that do not use severity.) Default value: `false` |
| `unspecified-severity-name` | [Optional] Name of the unspecified severity value. Default value: `Unspecified` |
