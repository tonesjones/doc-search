---
title: "Generating a Hyundai report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/generating-a-hyundai-report.html"
content_id: "UN4YCupOUGLFIj0jEYMhLA"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:38:30.028105+00:00"
---

# Generating a Hyundai report

The Hyundai report can only be generated via command line, as it is unavailable in GUI
mode.
...
To generate a Hyundai report, use the `cov-generate-hyundai-report` command
...
```
cov-generate-hyundai-report mydir/config.yaml --password console --project demo
```
