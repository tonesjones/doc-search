---
title: "Mobile OWASP Top 10 report configuration file"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/mobile-owasp-top-10-report-configuration-file.html"
content_id: "deemhIyHgCqRJxTxdkGkcg"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:39:02.263422+00:00"
---

# Mobile OWASP Top 10 report configuration file
...
The config.yaml file can also include a section to specify which version
of OWASP mobile the report should use. The default is
`2016`.

```
mobile-owasp-report:
  # Possible values: 2016, 2024
  # Default: 2016 
  owasp-version: 2016
```
