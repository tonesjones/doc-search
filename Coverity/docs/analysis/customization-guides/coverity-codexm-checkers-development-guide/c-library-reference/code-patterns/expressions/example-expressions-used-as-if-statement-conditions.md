...
content_id: "F9z1tVsoxAW8uRg3Qp2WXQ"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T23:31:28.487976+00:00"
---
...
For example, in the following snippet of target C# code:
...
The CodeXM `ifStatement` pattern detects either instance.
...
You could match the first of these conditions by using the expression pattern `variableReference` (which also matches the right-hand side of the second condition),
