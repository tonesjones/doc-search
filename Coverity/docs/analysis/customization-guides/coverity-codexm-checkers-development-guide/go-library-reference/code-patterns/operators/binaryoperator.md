...
content_id: "Uwg8CWcct46bl9H7JYg8bw"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T23:33:51.102335+00:00"
---

# binaryOperator

Matches all possible binary operations in Go code.
...
In both these cases, a `` binaryOperator { .operand == `*` } `` pattern matches some part of the expression.
In the left-hand case, it matches `b * c`.
In the right-hand case, it matches the entire expression.

## Example

The following CodeXM pattern matches only the multiplication ( `*` ) operator:
