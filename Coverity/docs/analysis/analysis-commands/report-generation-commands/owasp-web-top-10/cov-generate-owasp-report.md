---
title: "cov-generate-owasp-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cov-generate-owasp-report.html"
content_id: "6HIAdqHY4leD5nWNUcDqMg"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:12.588752+00:00"
---

# cov-generate-owasp-report

Generate an OWASP Top 10 report.

## Synopsis

```
cov-generate-owasp-report <configuration-file>
...
The OWASP Top 10 report generator uses analysis results for a Coverity Connect project to
evaluate the analyzed codebase. Based on this evaluation, it creates an OWASP Top 10
report, which details the assessments that were done, provides a summary of
...
```
cov-generate-owasp-report mydir/config.yaml --password console --project demo
```
