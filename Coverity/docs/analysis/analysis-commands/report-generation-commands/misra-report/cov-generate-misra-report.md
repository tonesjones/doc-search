---
title: "cov-generate-misra-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cov-generate-misra-report.html"
content_id: "Ky9NLhMJ6tmb~WJp3p2ZzQ"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:11.286944+00:00"
---

# cov-generate-misra-report

Generate a MISRA report from an existing MISRA report configuration.

## Synopsis

```
cov-generate-misra-report <configuration-file> 
...
The `cov-generate-misra-report` command creates a MISRA Report based
on a configuration file and current issue data in Coverity Connect.
...
This command will use the configuration file MyConfiguration.yaml to
generate a MISRA Report in the file MyReport.pdf. You will be
prompted to enter the Coverity Connect server password on the console.
