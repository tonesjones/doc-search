---
title: "cov-generate-hyundai-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cov-generate-hyundai-report.html"
content_id: "dyFzHm3yvO0V7Bzyvrgeag"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:07.978058+00:00"
---

# cov-generate-hyundai-report

Generate a Hyundai report from an existing Hyundai report configuration.

## Synopsis

```
cov-generate-hyundai-report <configuration-file> 
...
The `cov-generate-hyundai-report` command creates an updated Hyundai report
based on a configuration file and current issue data in Coverity Connect.
...
```
cov-generate-hyundai-report MyConfiguration.yaml --output MyReport.pdf --password console
```

This command uses the MyConfiguration.yaml file to generate a Hyundai
report in the MyReport.pdf file. You will be prompted to enter
the Coverity Connect server password in the console.
