---
title: "cov-generate-disa-stig-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cov-generate-disa-stig-report.html"
content_id: "9ea5h9d1yEWm1jZHUfTOSQ"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:06.653874+00:00"
---

# cov-generate-disa-stig-report

generates a DISA ASD STIG report.

## Synopsis

```
cov-generate-disa-stig-report <configuration-file> 
...
The `cov-generate-disa-stig-report` command creates a DISA STIG report which
details the assessments that were done and lists the location of the findings. For
information about the DISA ASD STIG report, including installation,
see the chapter "Coverity DISA ASD STIG report" in Configuring and Generating Coverity Reports.
...
```
cov-generate-disa-stig-report mydir/config.yaml --password console --project demo
```
