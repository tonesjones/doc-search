---
title: "cov-generate-cert-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/cov-generate-cert-report.html"
content_id: "NnabU56yAB49inz8279w_A"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:03.997318+00:00"
---

# cov-generate-cert-report

Generate a CERT Report from an existing CERT Report configuration.

## Synopsis

```
cov-generate-cert-report <configuration-file> 
...
The `cov-generate-cert-report` command creates an updated CERT
...
This command uses the MyConfiguration.yaml file to generate a
CERT Report in the MyReport.pdf file. You will be prompted to
enter the Coverity Connect server password in the console.
