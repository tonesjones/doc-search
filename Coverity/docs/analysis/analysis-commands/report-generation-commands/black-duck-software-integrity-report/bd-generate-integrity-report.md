---
title: "bd-generate-integrity-report"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/bd-generate-integrity-report.html"
content_id: "3EvJ30RFBMKLXvXvELfsEg"
version: "2026.6"
section: "Coverity Analysis"
scraped_at: "2026-08-12T19:43:20.440471+00:00"
---

# bd-generate-integrity-report

Generate a Black Duck Software Integrity report () from an existing  configuration.
...
The `bd-generate-integrity-report` command generates an updated Black Duck Software Integrity
report based on a configuration file and current issue data in Coverity Connect.
...
```
> bd-generate-integrity-report MyConfiguration.yaml --output MyReport.pdf --password console
```

This command uses the MyConfiguration.yaml file to generate a report that will be written to the
MyReport.pdf file. On the console, you will be prompted to
enter the Coverity Connect server password.
