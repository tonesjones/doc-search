...
content_id: "hZ86j81aSFAzQ93yFmtRVA"
version: "2026.6"
section: "Coverity Connect"
scraped_at: "2026-08-12T18:48:41.594264+00:00"
---
...
- On Linux, go to <install_dir>/bin and run the
  ...
  The command accepts the maintenance, start, stop, or status options. For example,
...
- On Windows, go to <install_dir>\bin and run the
  ...
  When Coverity Connect is installed as a service, the
  cov-im-ctl.exe program is often unnecessary because
  Coverity Connect starts and stops automatically when the system boots up or
  shuts down. When Coverity Connect is installed as a service, any administrator
  can use this program.

  When Coverity Connect is not installed as a service, only the user who installed
  Coverity Connect is able to use this program to start or stop it.
