---
title: "Retrieve identity provider (IdP) metadata"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/retrieve-identity-provider-idp-metadata.html"
content_id: "jUKX1sL17nLnNlIXVHwbig"
version: "2026.6"
section: "Coverity Connect APIs"
scraped_at: "2026-08-12T19:54:42.047526+00:00"
---

# Retrieve identity provider (IdP) metadata

Example GET request to retrieve the identity provider (IdP) metadata.

**cURL request**

```
curl --location \
--request GET "http://my_connect_host:8080/api/v2/samlConfigurations/my_saml_config/idpMetadata" \
...
```
{
  "idpMetadataFile": "<md:EntityDescriptor xmlns:md=\"urn:oasis:names:tc:SAML: 
2.0:metadata\" entityID=\"http: //www.okta.com/exk2huj0uaRMVd2bX5d7\"> 
...
e5kflkS4k4qKXxQScBVJvkb7P9qasf8K/af5OA==</ds:X509Certificate> </ds:X509Data> 
...
Location=\"https://dev-19112429.okta.com/app/dev-19112429_coverityconnect_1/
exk2huj0uaRMVd2bX5d7/sso/saml\"/> <md:SingleSignOnService 
Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect\" 
Location=\"https://dev-19112429.okta.com/app/dev-19112429_coverityconnect_1/
exk2huj0uaRMVd2bX5d7/sso/saml\"/> </md:IDPSSODescriptor></md:EntityDescriptor>",
  "code": null,
  "message": null
}
```
