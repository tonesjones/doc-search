---
title: "Retrieve all column keys for issue occurrences"
source_url: "https://docs.blackduck.com/r/coverity/2026.6/coverity-documentation/retrieve-all-column-keys-for-issue-occurrences.html"
content_id: "jLsx0u8P9U7NUsTdpO21Ig"
version: "2026.6"
section: "Coverity Connect APIs"
scraped_at: "2026-08-12T19:53:59.612461+00:00"
---

# Retrieve all column keys for issue occurrences

Example GET request to retrieve all column keys for the view type **Issues: By
Snapshot** (with the **Issue Occurrences** checkbox enabled).

**cURL request**

```
curl --location \
--request GET "http://my_connect_host:8080/api/v2/issueOccurrences/columns?\
locale=en_us&queryType=bySnapshot" \
