...
content_id: "6rSd7Ok~bwpCJ5aWjaCdBA"
version: "2026.6"
section: "Clients, plug-ins, integrations, and APIs"
scraped_at: "2026-08-12T19:47:57.497212+00:00"
---
...
To construct your filter settings,
click the Filter button ( [image: image] ). This launches the
Edit Filters window:

Figure 1. Edit Filters window
[image: image]
...
and select the Copy button ( [image: image] ) to edit the filter's
configuration.
