...
content_id: "5y5RCRFRcegQpXRfzmlvLA"
version: "2026.6"
section: "Clients, plug-ins, integrations, and APIs"
scraped_at: "2026-08-12T19:49:05.325376+00:00"
---
...
- There may be files added to your workspace since your last build that are
  ...
  Build command in the Tools > Coverity menu.
...
Security analysis Coverity Desktop can perform local security
analysis using the security checkers, but requires running a whole program analysis.
Be sure that the selected analysis configuration has the When running
Analyze Scope, run all enabled whole program checkers option
selected, from the Advanced > Analysis page.
