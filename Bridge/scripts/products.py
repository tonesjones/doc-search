#!/usr/bin/env python3
"""Product/map registry for the Bridge CLI documentation corpus."""
...
BRIDGE_ROOT_SLUGS: OrderedDict[str, str] = OrderedDict(
    [
        ("Azure DevOps Integrations", "azure-devops-integrations"),
        ("Bitbucket Integrations", "bitbucket-integrations"),
        ("Bridge CLI", "bridge-cli"),
        ("Bridge CLI reference", "bridge-cli-reference"),
        ("Bridge glossary", "bridge-glossary"),
        ("Bridge product overview", "bridge-product-overview"),
        ("Bridge support matrix", "bridge-support-matrix"),
        ("Central Integrations release notes", "central-integrations-release-notes"),
        ("Configuring proxy for Bridge", "configuring-proxy-for-bridge"),
        ("GitHub Integrations", "github-integrations"),
        ("GitLab Integrations", "gitlab-integrations"),
        ("Jenkins - Black Duck Security Scan Plugin for Jenkins", "jenkins-black-duck-security-scan-plugin-for-jenkins"),
...
DEFAULT_PRODUCT_KEY = "bridge-latest"
