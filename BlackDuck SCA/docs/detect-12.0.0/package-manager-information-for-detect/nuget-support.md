---
title: "NuGet support"
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/nuget-support.html"
...
Tip: When running the NuGet Solution Native Inspector the `--detect.detector.search.depth=` value is ignored if a solution (.sln or .slnx) file is found that contains project references that include subdirectories at levels lower than the specified search depth.
