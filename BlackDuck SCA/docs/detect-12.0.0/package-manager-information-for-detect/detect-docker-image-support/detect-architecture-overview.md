...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/detect-architecture-overview.html"
content_id: "FN0L6V0Tc2WjqNwKGvWYnQ"
version: "12.0.0"
section: "Package Manager information for Detect"
scraped_at: "2026-09-07T21:16:05.891751+00:00"
---

# Detect architecture overview

Detect Docker Inspector uses container-based image inspector services;
...
needed from Docker Hub the following images: blackducksoftware/blackduck-imageinspector-alpine, and blackducksoftware/blackduck-imageinspector-ubuntu.
...
between the Detect Docker Inspector utility and the service containers.

In container mode, start the container running Detect Docker Inspector and the image inspector container-based services such that
