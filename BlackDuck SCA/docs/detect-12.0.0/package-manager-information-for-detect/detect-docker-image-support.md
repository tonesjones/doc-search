...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/detect-docker-image-support.html"
...
On Linux, Mac, and Windows, Detect can invoke Detect Docker Inspector to inspect Linux Docker images to discover packages installed by the Linux package manager.
