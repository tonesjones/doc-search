...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/release-notes-for-jenkins-plugin.html"
...
- This release is compatible with Black Duck® Detect 12.x.x. (Downloading and using detect12.(sh/ps1)).

**Changed features**

- Updated to use Black Duck® Detect 12.x.x for execution.
