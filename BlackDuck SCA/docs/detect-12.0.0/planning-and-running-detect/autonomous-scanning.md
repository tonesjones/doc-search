...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/autonomous-scanning.html"
...
- OFFLINE mode: When
  ...
  - [Binary scan](https://docs.blackduck.com/r/blackduck/latest/black-duck-documentation/black-duck-binary-analysis.html): Will run if
  ...
  - Signature scan: Will run against source files if scan cli is
    available. If [scan cli](https://docs.blackduck.com/r/blackduck/latest/black-duck-documentation/downloading-and-installing-the-signature-scanner-cli.html) is not locally
