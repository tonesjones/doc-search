...
See the Black Duck documentation for futher details on [Infrastructure as Code scanning.](https://docs.blackduck.com/r/blackduck/latest/black-duck-documentation/infrastructure-as-code.html)
