...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/choosing-a-run-method-script-.jar-or-docker-container-.html"
content_id: "ZCv3Bfb7td9029~dp653mA"
version: "12.0.0"
section: "Planning and running Detect"
scraped_at: "2026-09-07T21:15:29.409294+00:00"
---
...
If you are running Detect with Black Duck SCA you can also configure the version of Detect that should be used. See [Hosting location for Black Duck Detect](https://docs.blackduck.com/r/blackduck/latest/black-duck-documentation/hosting-location-for-black-duck-detect.html).
...
direct control over the exact Detect version. Detect does not automatically update in this scenario unless configured in Black Duck SCA to do so. See [Hosting location for Black Duck Detect](https://docs.blackduck.com/r/blackduck/latest/black-duck-documentation/hosting-location-for-black-duck-detect.html).
