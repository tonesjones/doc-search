...
source_url: "https://docs.blackduck.com/r/detect/12.0.0/black-duck-detect/common-detect-troubleshooting-solutions.html"
...
2. Determine which *java* executable is being used to run Detect. If you run detect12.sh, that is either $JAVA_HOME/bin/java (the default) or the first *java* found on your $PATH.
