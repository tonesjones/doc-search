---
title: "SBT support"
source_url: "https://docs.blackduck.com/r/detect/11.5.1/black-duck-detect/sbt-support.html"
content_id: "P~LPjKIGQSPULIJMd9Vc6Q"
version: "11.5.1"
section: "Package Manager information for Detect"
scraped_at: "2026-08-08T23:45:11.382684+00:00"
---
...
Detect runs the dependecyDot task when it finds the following in your project

- build.sbt

The SBT detector requires a compatible dependency graph plugin and the "depedencyDot" task to generate dependency graphs for SBT projects. The plugin generates dot file graphs for each project and Detect parses each dot graph into it's own code location.
...
Detect verfies the plugin is installed by running "sbt plugins" and looking for any of the following plugin names in the output. You can also perform this check yourself by running the same command.
...
This can cause Detect to suspend, if Detect is run in the background,
