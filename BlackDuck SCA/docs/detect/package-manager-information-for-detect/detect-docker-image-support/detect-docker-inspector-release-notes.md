---
title: "Detect Docker Inspector Release notes"
source_url: "https://docs.blackduck.com/r/detect/11.5.1/black-duck-detect/detect-docker-inspector-release-notes.html"
content_id: "vl6Fx0AumGrOWwJqZdliKg"
version: "11.5.1"
section: "Package Manager information for Detect"
scraped_at: "2026-08-08T23:44:54.838478+00:00"
---

# Detect Docker Inspector Release notes

Attention: Package manager inspection support for CentOS based images has been deprecated in Detect 11.5.0 and will be removed in 12.0.0. CentOS Linux has reached end of life upstream (CentOS Linux 8 in 2021; CentOS Linux 7 in 2024). Once an OS is EOL, it stops receiving regular security and maintenance updates, which inevitably lowers our confidence in any package manager based analysis. As with any other unsupported image, Docker Inspector will still provide Detect with targets for signature and binary scanning.
...
- Changed Detect Docker Inspector's JAR signing authority from Synopsys, Inc to Black Duck Software, Inc.
...
- (IDOCKER-785) Detect Docker Inspector now supports Docker Versions 25 and 26.
