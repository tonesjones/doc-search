...
source_url: "https://docs.blackduck.com/r/detect/11.5.1/black-duck-detect/using-a-configuration-file.html"
content_id: "hkHgxPu18QjFfVCPREJQZA"
version: "11.5.1"
section: "Configuring Detect"
scraped_at: "2026-08-08T23:44:18.798980+00:00"
---

# Using a configuration file

Another commonly-used method of configuring Detect is to provide a configuration file. The configuration file
can be a Java properties (.properties) file, or a YAML (.yml) file.

Note: Configuration files support all properties, only the formatting, as noted below, changes based on the type of configuration file employed. See All Properties.
...
## Running Detect from a directory that contains a file named *config*

If a file named *config* exists in the directory from which you run Detect,
