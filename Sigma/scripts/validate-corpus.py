#!/usr/bin/env python3
"""Validate Sigma topic files, metadata, and stored content hashes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Sigma corpus files and manifest metadata")
